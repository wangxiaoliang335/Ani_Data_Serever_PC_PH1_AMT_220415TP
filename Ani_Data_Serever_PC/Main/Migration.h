...
// BtnEnh grid on inspect view: lighter flat surface + light text (readability on dark theme)
const COLORREF INSPECT_GRID_BACK = RGB(115, 115, 122);
const COLORREF INSPECT_GRID_BACK_MO = RGB(138, 138, 146);
const COLORREF INSPECT_GRID_FORE = RGB(240, 240, 245);
